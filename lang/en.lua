...
ZO_CreateStringId("SI_BUI_INV_EQUIPSLOT_MAIN","Primary")
ZO_CreateStringId("SI_BUI_INV_EQUIPSLOT_OFF","Secondary")

ZO_CreateStringId("SI_BUI_INV_EQUIP_PROMPT_MAIN","Primary")
ZO_CreateStringId("SI_BUI_INV_EQUIP_PROMPT_BACKUP","Secondary")
...
ZO_CreateStringId("SI_BUI_INV_EQUIPSLOT_MAIN","Primary Weapon")
ZO_CreateStringId("SI_BUI_INV_EQUIPSLOT_BACKUP","Secondary Weapon")
